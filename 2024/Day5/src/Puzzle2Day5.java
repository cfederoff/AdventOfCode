        ...
        try {
            ...
            while ((line = file.readLine()) != null){
                ...
                if (!orderingCorrect){
                    ...
                    int[] orderedAnswer = new int[numbersToCheck.length];
                    for (int i = 0; i < numbersToCheck.length; i++) {
                        for (int j = 0; j < numbersToCheck.length; j++) {
                            boolean lowestFound = true;
                            int currentNumber = numbersToCheck[j];
                            if (currentNumber == -1){
                                continue;
                            }
                            for (int k = 0; k < size; k++){
                                if (currentNumber == numbersCopy[k][1]){
                                    lowestFound = false;
                                    break;
                                }
                            }
                            if (lowestFound){
                                ...
                                orderedAnswer[i] = currentNumber;
                                break;
                            }
                        }
                    }
                    total += orderedAnswer[orderedAnswer.length/2];
                }
            }
